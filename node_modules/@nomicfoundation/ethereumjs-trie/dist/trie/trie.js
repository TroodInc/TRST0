...
class Trie {
    ...
    root(value) {
        if (value !== undefined) {
            if ((0, ethereumjs_util_1.isFalsy)(value)) {
    ...
    async put(key, value) {
        ...
        if ((0, ethereumjs_util_1.isFalsy)(value) || value.toString() === '') {
    ...
    async _deleteNode(k, stack) {
        const processBranchNode = (key, branchKey, branchNode, parentNode, stack) => {
            ...
            if ((0, ethereumjs_util_1.isFalsy)(parentNode) || parentNode instanceof node_1.BranchNode) {
                // branch->?
                if ((0, ethereumjs_util_1.isTruthy)(parentNode)) {
        ...
        if ((0, ethereumjs_util_1.isFalsy)(lastNode))
    ...
    async batch(ops) {
        for (const op of ops) {
            if (op.type === 'put') {
                if ((0, ethereumjs_util_1.isFalsy)(op.value)) {
    ...
    async fromProof(proof) {
        ...
        if (this.root() === this.EMPTY_TRIE_ROOT && (0, ethereumjs_util_1.isTruthy)(opStack[0])) {
