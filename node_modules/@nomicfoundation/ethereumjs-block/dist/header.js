...
class BlockHeader {
    ...
    constructor(headerData, options = {}) {
        ...
        const coinbase = (0, ethereumjs_util_1.isTruthy)(headerData.coinbase)
            ? new ethereumjs_util_1.Address((0, ethereumjs_util_1.toType)(headerData.coinbase, ethereumjs_util_1.TypeOutput.Buffer))
            : defaults.coinbase;
    ...
    _genericFormatValidation() {
        ...
        if (this._common.isActivatedEIP(1559) === true) {
            ...
            if ((0, ethereumjs_util_1.isTruthy)(londonHfBlock) && this.number === londonHfBlock) {
    ...
    validateGasLimit(parentBlockHeader) {
        ...
        if ((0, ethereumjs_util_1.isTruthy)(londonHardforkBlock) && this.number === londonHardforkBlock) {
    ...
    _validateDAOExtraData() {
        ...
        if ((0, ethereumjs_util_1.isFalsy)(DAOActivationBlock) || this.number < DAOActivationBlock) {
            return;
        }
