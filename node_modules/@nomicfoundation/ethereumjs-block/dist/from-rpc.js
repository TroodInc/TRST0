...
function normalizeTxParams(_txParams) {
    ...
    txParams.to = (0, ethereumjs_util_1.isTruthy)(txParams.to) ? (0, ethereumjs_util_1.setLengthLeft)((0, ethereumjs_util_1.toBuffer)(txParams.to), 20) : null;
...
function blockFromRpc(blockParams, uncles = [], options) {
    ...
    const transactions = [];
    if ((0, ethereumjs_util_1.isTruthy)(blockParams.transactions)) {
