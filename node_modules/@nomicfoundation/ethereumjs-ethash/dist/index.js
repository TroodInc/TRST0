...
class Miner {
    ...
    async iterate(iterations = 0) {
        ...
        while (iterations !== 0 && !this.stopMining) {
            ...
            if ((0, ethereumjs_util_1.isTruthy)(solution)) {
                return solution;
            }
        }
    }
...
class Ethash {
    ...
    run(val, nonce, fullSize) {
        if ((0, ethereumjs_util_1.isFalsy)(fullSize) && (0, ethereumjs_util_1.isTruthy)(this.fullSize)) {
            fullSize = this.fullSize;
        }
        if ((0, ethereumjs_util_1.isFalsy)(fullSize)) {
