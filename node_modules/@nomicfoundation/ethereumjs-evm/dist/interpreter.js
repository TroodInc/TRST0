...
class Interpreter {
    ...
    async _baseCall(msg) {
        ...
        // Set return value
        if ((0, ethereumjs_util_1.isTruthy)(results.execResult.returnValue) &&
    ...
    async _selfDestruct(toAddress) {
        ...
        if ((0, ethereumjs_util_1.isFalsy)(this._result.selfdestruct[this._env.address.buf.toString('hex')])) {
