...
exports.EvmErrorResult = exports.INVALID_EOF_RESULT = exports.INVALID_BYTECODE_RESULT = exports.COOGResult = exports.OOGResult = exports.EVM = void 0;
...
class EVM {
    ...
    async _executeCreate(message) {
        ...
        let exit = false;
        if ((0, ethereumjs_util_1.isFalsy)(message.code) || message.code.length === 0) {
            exit = true;
            if (this.DEBUG) {
                debug(`Exit early on no code`);
            }
        ...
        if (!result.exceptionError &&
            (0, ethereumjs_util_1.isTruthy)(result.returnValue) &&
